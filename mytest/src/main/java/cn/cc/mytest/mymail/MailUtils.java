...
public class MailUtils {
    ...
    public static void main(String[] args) {
        ...
        // 设置发件人地址、收件人地址和邮件标题
        cn.setAddress("chen-sir441@163.com", "1012891486@qq.com", "告警:大华容器云-容器CPU监控-容器CPU负载高");
        
        // 设置要发送附件的位置和标题
//        cn.setAffix("d:/123.txt", "123");
        ...
        cn.send("smtp.163.com", "chen-sir441@163.com", "dahuatech34049");
