package concurrent.javaConcurrency.chapter04.unit05.core;

import java.util.concurrent.ExecutionException;
import java.util.concurrent.ExecutorService;
import java.util.concurrent.Executors;

import concurrent.javaConcurrency.chapter04.unit05.task.TaskValidator;
import concurrent.javaConcurrency.chapter04.unit05.task.UserValidator;
