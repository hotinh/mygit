package concurrent.javaConcurrency.chapter03.unit05.core;

import java.util.concurrent.CyclicBarrier;

import concurrent.javaConcurrency.chapter03.unit05.task.Grouper;
import concurrent.javaConcurrency.chapter03.unit05.task.Searcher;
import concurrent.javaConcurrency.chapter03.unit05.utils.MatrixMock;
import concurrent.javaConcurrency.chapter03.unit05.utils.Results;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		for (int i=0; i<searchers.length; i++) {
			searchers[i] = new Searcher(barrier, 
					i*LINES_PARTICIPANT,
