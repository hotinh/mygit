package concurrent.javaConcurrency.chapter01.unit03.core;
...
import concurrent.javaConcurrency.chapter01.unit03.task.Calculator;

public class Main {
	public static void main(String[] args) {

		// 线程优先级信息
		System.out.printf("Minimum Priorit:%s\n", Thread.MIN_PRIORITY);
		...
		try {
			...
			// 创建一个记录文件对象
			File logFile = new File(configFile + "/data/log.text");
