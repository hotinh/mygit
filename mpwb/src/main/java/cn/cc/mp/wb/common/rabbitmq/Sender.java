...
public class Sender implements RabbitTemplate.ConfirmCallback, ReturnCallback {
    ...
    public void send2(String msg){
        ...
        System.out.println("开始发送消息 : " + msg);
        rabbitTemplate.convertAndSend("topicExchange", "key.1", msg, correlationId);
    ...
    public void send(Object obj){
        ...
        String response = rabbitTemplate.convertSendAndReceive("topicExchange", "key.1", obj, correlationId).toString();
