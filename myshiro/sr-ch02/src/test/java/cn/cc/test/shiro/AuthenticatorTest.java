...
//        principalCollection.asList().stream().forEach(System.out :: println);
    ...
    public void testFirstOneSuccessfulStrategyWithSuccess() {
        login("classpath:auth-authenticator-first-success.ini");
        Subject subject = SecurityUtils.getSubject();
    ...
    public void testAtLeastTwoStrategyWithSuccess() {
        login("classpath:auth-authenticator-atLeastTwo-success.ini");
        Subject subject = SecurityUtils.getSubject();
    ...
    public void testOnlyOneStrategyWithSuccess() {
        login("classpath:auth-authenticator-onlyone-success.ini");
        Subject subject = SecurityUtils.getSubject();
